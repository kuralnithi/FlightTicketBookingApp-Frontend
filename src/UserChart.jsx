...
console.log("error in fetching user details",error);
  ...
  return (
    <div onResize={()=>{location.window.reload}}>
...
<div className="chartdi">
        ...
        <button className='refresh btn bx bx-refresh fs-2' onClick={()=>{location.reload()}}></button>
      ...
      <div className="btnn  container-fluid text-cenetr row">
                ...
                <button onClick={handleGotouser}  className='chrtbtn btn btn-danger mx-1 mt-1 mb-1'>Go to user page</button>
                <button onClick={handleGotosearch} className='chrtbtn btn btn-primary mx-1 mt-1 mb-1' >Go to search page</button>
